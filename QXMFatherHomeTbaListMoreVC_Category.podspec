...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of QXMFatherHomeTbaListMoreVC_Category.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangxieomeng1/QXMFatherHomeTbaListMoreVC_Category'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangxieomeng1' => 'zhangxiaomeng@xiangshang360.com' }
  s.source           = { :git => 'https://github.com/zhangxieomeng1/QXMFatherHomeTbaListMoreVC_Category.git', :tag => s.version.to_s }
